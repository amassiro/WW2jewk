...
void DrawMGtestBEWK(std::string var = "mWW", int NBIN = 1000, int MIN = 0, int MAX = 1000, std::string varHR = "mWW") {
...
//    h_Ratio -> SetBinContent (iBin+1, (ewk - qcd) / ewk);
 ...
 std::cout << std::endl;
 std::cout << " --------------------------- " << std::endl;
 std::cout << " ewk w/  b   = " << h_mWW_1->Integral() << std::endl;
 std::cout << " ewk w/o b   = " << h_mWW_2->Integral() << std::endl;
 std::cout << " --------------------------- " << std::endl;
 std::cout << std::endl; 
}